![OLD DIiSTwiCS](Squall's%20End%20Map.png)  

### Population:

- Approximately 1900; mixed human and other civilized races.

### Government:

- Baron of Squall's End: Vanan Shattermast

### Notable Places:

- Aehelm's Pewter: A large pewtersmith's workshop, decorated with a collection of brass lamps from many kingdoms.
- The Guildhall: An impressive building of timber and brick walls, once an aristocrat's manor. It contains a large meeting hall and several smaller rooms, and is shared amongst several local trade guilds.
